...
<div id="slider">
    ...
    <div id="templatemo_sidebar">
        ...
        <ul class="navigation">
        	<li><a href="#an">Information<span class="ui_icon gallery"></span></a></li>
                ...
                <div class="scrollContainer">
                    ...
                    <div class="panel" id="no">
                    	...
                    	echo "<br/>";
											 ...
											 $result=mysql_query("select *
											  from follow  natural join student natural join company
											 ...
											 {
											 	echo "<h4>Followed</h4>";
											 	echo "<h2><a href='dele_follow.php?cid=$cid'>"."Unfollow</a></h2>";
											}
											else
											{
												echo "<h2><a href='add_follow.php?cid=$cid'>"."Follow</a></h2>";
											}
