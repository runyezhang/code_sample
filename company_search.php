...
<div id="slider">
    ...
    <div id="templatemo_sidebar">
        ...
        <ul class="navigation">
            <li><a href="#sf">Search Company<span class="ui_icon gallery"></span></a></li>
            <li><a href="#fr">My Follows<span class="ui_icon gallery"></span></a></li>
        </ul>
    </div> <!-- end of sidebar -->
            ...
            <div class="scroll">
                <div class="scrollContainer">
                    ...
                    <div class="panel" id="sf">
                    	...
                    	if(isset($_POST['search_c']) && !empty($_POST['search_c'])) 
                    	{
                    		$searchs = $_POST['search_c'];
                    		require_once('db_fns.php');
	                    	$con = db_connect();
	                    	mysql_select_db("jobwalla",$con);
	                    	$result=mysql_query("select *
											  from company 
											  where c_name LIKE '%$searchs%'")
                     or die(mysql_error()); 
											 while($row=mysql_fetch_array($result))
											 {
											 	 echo "<a href='company_info.php?cid=".$row['cid']."'>Company name:".$row['c_name']."</a>"; 
											 	 echo "<br/>";
											 	 echo "Industry:".$row['industry'];echo "<br/>";
